    ...
    <div className="space-y-10 py-8 px-4 md:px-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm">
            Setor 10 liter bulan ini dan dapatkan bonus saldo Rp 25.000!
          </p>{" "}
        </div>{" "}
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            {" "}
            Satu liter minyak jelantah bisa mencemari hingga 1 juta liter air
            bersih. Yuk, setor minyakmu sekarang demi lingkungan!{" "}
          </p>{" "}
        </div>{" "}
      </motion.div>{" "}
    </div>
